    ...
    render() {
      ...
      return (
        <div className="flex flex-col min-h-full">
          ...
          <div className="flex flex-col md:flex-row w-full productDetail-wrap py-12 px-12 md:py-36 md:px-36">
            ...
            <div className="flex flex-col h-3/6 md:w-4/6 md:h-full md:ml-10 md:mt-5">
              <div className="flex flex-col w-full h-5/6 md:h-4/6 p-5 md:px-20 md:py-12 rounded-2xl bg-white">
                ...
                <p className="text-sm md:text-lg productDetail-font-p productDetail-detailDel brown my-4">
                  {this.props.product.detailData.detail}
                </p>
                <div className="w-full text-center text-sm md:text-2xl md:my-6 productDetail-font-p font-bold">
                  Choose a size
                </div>
