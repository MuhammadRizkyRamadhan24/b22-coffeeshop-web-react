        ...
        <div className="flex flex-col min-h-full">
          ...
          <div className="flex flex-row w-full productDetail-wrap py-12 px-36">
            <div className="flex flex-col w-2/6 items-center">
              ...
              <p className="text-2xl productDetail-font-p font-normal text-center w-full">
                IDR
                {' '}
            ...
            <div className="flex flex-col w-4/6 ml-10 mt-5">
              ...
              <div className="flex flex-col w-full h-2/6">
                ...
                <div className="flex flex-row w-full justify-center items-center">
                  <button type="button" className="rounded-2xl w-40 h-16 mt-5 mb-3 mx-3 text-lg productDetail-btn focus:outline-none bg-white target">Dine In</button>
                  <button type="button" className="rounded-2xl w-40 h-16 mt-5 mb-3 mx-3 text-lg productDetail-btn focus:outline-none bg-white target">Door Delivery</button>
                  <button type="button" className="rounded-2xl w-40 h-16 mt-5 mb-3 mx-3 text-lg productDetail-btn focus:outline-none bg-white target">Pick up</button>
                </div>
              </div>
            </div>
          </div>
          <div className="absolute w-full h-40 flex flex-row px-24 justify-center items-center" style={{ top: '60rem' }}>
                ...
                ? this.state.item.map((d) => (
                  <div key={d.id} className="flex flex-row h-full w-full items-center">
                    ...
                    <div className="flex flex-row w-48">
                      <button type="button" onClick={this.minusValue} className="rounded-full h-8 w-8 font-bold text-xl productDetail-btn focus:outline-none productDetail-bg-yellow">-</button>
                      <div className="text-xl productDetail-font-p font-extrabold px-8">
                        {this.state.number}
                      </div>
                      <button type="button" onClick={this.plusValue} className="rounded-full h-8 w-8 font-bold text-xl productDetail-btn focus:outline-none productDetail-bg-yellow">+</button>
                    </div>
                  </div>
                ))
                : (
            ...
            <button type="button" onClick={() => this.addItems(this.state.item[0])} disabled={this.state.button} className="flex justify-center items-center h-full w-1/6 text-xl font-bold productDetail-btn productDetail-font-p focus:outline-none productDetail-bg-yellow rounded-2xl shadow-md ml-5">
              CHECKOUT
            </button>
          </div>
          <Footer />
